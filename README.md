...
Please edit the contents of the `.env` file in `angularnest-be` to your database information (database name, username, password, port, etc).

You can find the SQL database for this project in the root of this repository under the name of `todo.sql`.
